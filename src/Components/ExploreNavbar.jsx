...
const ExploreNavbar = () => {
  ...
  const shouldShowSignInButton = ['/', '/login', '/signup'].includes(location.pathname);
    ...
    <nav className="p-5 w-full">
      <div className="flex lg:flex-row flex-col justify-between items-between">
        <div className="flex justify-between">
          ...
          {
            shouldShowSignInButton ?  (<div className="lg:hidden flex items-center gap-3">
            <Link
              to="/login"
          ...
          </div>) : ( <div className="flex gap-2 items-center lg:hidden focus:outline-none">
       ...
       >
        ...
        <div className={`lg:hidden ${isMenuOpen ? "block" : "hidden"}`}>
          ...
          <Link to="/" className="lg:text-sm text-xs font-normal md:text-sm  font-sans flex items-center gap-2">
            ...
            <Link
              ...
              className="lg:text-sm text-xs font-normal md:text-sm  font-sans  flex items-center  gap-2"
            >
              <span className=""><CredentialsIcon/></span>
            ...
            <Link
              ...
              className="lg:text-sm text-xs font-normal md:text-sm  font-sans  flex items-center gap-2"
            >
              <span><StudentsIcon/></span>
              <span>Students</span>
              
            </Link>
            
              <Link to="" className="bg-primary  rounded-full relative lg:text-sm text-xs font-normal md:text-sm  font-sans  flex items-center gap-4">
              ...
              <Link to="/messagescreen" className="bg-primary  rounded-full relative lg:text-sm text-xs font-normal md:text-sm  font-sans  flex items-center gap-4" >
                <img
                  src={messageIcon}
                  alt="MessageIcon"
                  style={{width:"24",height:"24"}}
        ...
        {shouldShowSignInButton ? ( <div className="flex items-center gap-3">
                  <Link
                    to="/login"
                    className="bg-primary lg:text-base text-sm font-normal text-white lg:p-2.5 p-1.5 rounded"
                  >
