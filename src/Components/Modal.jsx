...
const CustomModal = ({ isOpen, onRequestClose,count,handleChange }) => {
  ...
  return (
    ...
    >
      ...
      <input type="number" className='border text-xs p-1' value={count} style={{width:"140px"}} placeholder='Enter count eg:2' onChange={(e)=>handleChange(e)}/>
      ...
      <button
        ...
        <Link to="/duplicate" className="bg-primary p-2 text-white rounded-md text-xs"  onClick={() => onRequestClose()}>
          Ok
        </Link>
      </div>
    </Modal>
