...
function ChatItem({ name, message, time, icon, isMuted, handleAllChatsClick,handleChartStart }) {
  return (
    <div className="px-4 my-2 cursor-pointer" onClick={()=>handleChartStart()}>
      <div className="flex gap-4">
        <div>
        <img src={icon} alt="student" width="50px" height="50px" />
        </div>
      
        <div className="flex items-center w-full justify-between"   onClick={handleAllChatsClick}>
