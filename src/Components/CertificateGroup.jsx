    ...
    return(
      <>
       <div className="w-full lg:h-60 h-auto mb-4 card md:block hidden">
        <div className="flex flex-wrap justify-evenly lg:p-6 p-10 items-center lg:gap-2 gap-8  certificateCard rounded-md w-auto lg:h-60 h-auto ">
          <Certificate />
          <Certificate />
          <Certificate />
       ...
       <div className="w-full certificateCard p-2 h-auto mb-4 pb-6 card block md:hidden rounded-lg">
