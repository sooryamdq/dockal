          ...
          <div className="bg-white w-[90%] h-[519px] bg-white p-3 relative">
            <Link className="flex md:flex-row flex-col items-center justify-between">
              <div className="bg-[#D9D9D9] w-20 h-20 rounded-full flex justify-center items-center">
                <Paragraph text="Upload your logo here" className="font-normal text-[10px] text-center" />
              </div>
            ...
            <div className="text-center ">
              ...
              <div>
                <Paragraph text="This is to certify that" className="text-base text-center font-normal text-[#2F2F2F] py-1" />
                  
            
              </div>
            </div>
            <div className="text-center flex flex-col items-center gap-3 py-1">
              <Paragraph text="Enter the student name" className="text-[#5D5D5D] font-medium text-sm"/>
            ...
            <div className="flex justify-between iteems-center py-4 px-5">
              ...
              <Paragraph text="Enter College Name" className="text-[#5D5D5D] font-medium text-sm"/>
            ...
            <div className="text-center py-4 lg:text-base text-xs">
              <p>
                project completion themed under SDG in the category of
                College at{" "}
